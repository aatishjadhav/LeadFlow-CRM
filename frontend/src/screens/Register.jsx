...
const Register = () => {
  ...
  <div className="card shadow-lg border-0 p-4 rounded-4" style={{ width: "400px", backgroundColor: "#ffffff" }}>
    <h2 className="text-center mb-3 fw-bold" style={{ color: "#198754" }}>Create Account</h2>
    <p className="text-center text-muted mb-4">Join us by creating your account</p>
    <form onSubmit={handleSubmit}>
      <div className="mb-3">
      ...
      <div className="d-grid">
        <button className="btn btn-success btn-lg rounded-3 shadow-sm" type="submit">
          Register
        </button>
      </div>
      ...
      <div className="text-center mt-4">
        ...
        <Link to="/" className="text-decoration-none fw-semibold" style={{ color: "#198754" }}>
          Login here
        </Link>
      </div>
    </form>
