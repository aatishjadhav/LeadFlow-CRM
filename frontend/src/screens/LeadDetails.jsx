...
const LeadDetails = () => {
  ...
  <div className="card mb-4">
    <div className="card-body">
      ...
      <p className="card-text"><strong>Lead Name:</strong> {getLead.name}</p>
      <p className="card-text"><strong>Sales Agent:</strong> {getLead.salesAgent.name}</p>
      <p className="card-text"><strong>Lead Source:</strong> {getLead.source}</p>
      <p className="card-text"><strong>Lead Status:</strong> {getLead.status}</p>
      <p className="card-text"><strong>Priority:</strong> {getLead.priority}</p>
      <p className="card-text"><strong>Time to Close:</strong> {getLead.timeToClose} days</p>
      <Link
    ...
    {comments.length > 0 ? (
      comments.map((comment) => (
        <div className="border p-3 rounded mb-2" key={comment._id}>
          <p className="mb-1"><strong>Author:</strong> {comment.author}</p>
          <p className="mb-0"><strong>Comment:</strong> {comment.commentText}</p>
        </div>
      ))
    ) : (
